// This file sends info from the
// modal to mixpanel No matter what,
// you will need to add your own *mixpanel
// id to this file*

// If you add new fields to the form, you
// will also need to add them to the *get all inputs*
// section. If you want to make them required,
// add them to the *validation section*.

var mixpanel_id = "ea3908c1a72acbd65ecde40918b66104";
